    ...
    return {
        ...
        output: {
            ...
            filename: isEnvProduction
                ? '[name]/js/index.js'
                : isEnvDevelopment && '[name]/js/index.js',
        ...
        plugins: [
            process.env.ENV === 'local' && isEnvProduction && new BundleAnalyzerPlugin(),
            ...
            isEnvProduction &&
                new MiniCssExtractPlugin({
                    ...
                    chunkFilename: '[name]/css/style.s.css',
                }),
