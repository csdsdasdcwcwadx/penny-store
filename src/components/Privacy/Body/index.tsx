...
function Body () {
    return (
        <div className={styles.privacy}>
            ...
            <ul>
                <li className={styles.title}>資料之保護</li>
            ...
            <ul>
                <li className={styles.title}>網站對外的相關連結</li>
                <li>本網站的網頁提供其他網站的網路連結，您也可經由本網站所提供的連結，點選進入其他網站。但該連結網站不適用本網站的隱私權保護政策，您必須參考該連結網站中的隱私權保護政策。</li>
            </ul>
            <ul>
                <li className={styles.title}>與第三人共用個人資料之政策本網站絕不會提供、交換、出租或出售任何您的個人資料給其他個人、團體、私人企業或公務機關，但有法律依據或合約義務者，不在此限。
前項但書之情形包括不限於：</li>
                <li>經由您書面同意。</li>
                <li>法律明文規定。</li>
            ...
            <ul>
                <li className={styles.title}>Cookie 之使用</li>
                <li>為了提供您最佳的服務，本網站會在您的電腦中放置並取用我們的 Cookie，若您不願接受 Cookie 的寫入，您可在您使用的瀏覽器功能項中設定隱私權等級為高，即可拒絕 Cookie 的寫入，但可能會導致網站某些功能無法正常執行 。</li>
            </ul>
            <ul>
                <li className={styles.title}>隱私權保護政策之修正</li>
